...
describe('calculatePerMonth', () => {
    it('should return end and start date from last month to 20 years ago', async () => {
        ...
        const result = await monthCalculator.calculatePerMonth(input);
...
describe('calculateTempurature', () => {
    it('should return average temperature per month', async () => {
        const input = {
            '0': {
        ...
        const result = await monthCalculator.calculateTempurature(input);
        const expectedResponse = { 
...
describe('calculatePrecipitation', () => {
    it('should return average temperature per month', async () => {
        ...
        const result = await monthCalculator.calculatePrecipitation(input);
        const expectedResponse = { 
