...
\addcontentsline{toc}{subsection}{Sub-question \#1: What are the primary front and back-end technologies and components utilized in the QaaS
      web application, and how do they function together to as a system?}
\addcontentsline{toc}{subsection}{Sub-question \#2: What is SentinelOne EDR Platform?}
\addcontentsline{toc}{subsection}{Sub-question \#3: How can SentinelOne be integrated within the QaaS App?}
\addcontentsline{toc}{subsection}{Sub-question \#4: How can SentinelOne data best be displayed to non-technical users?}
\begin{enumerate}
...
Furthermore, the reliability of these results is anchored in the application of selected research methods,
...
% is allowed to do only GET requests. This is because that the author is not allowed to do any PATCH,
...
% not give access for them to change the data. Therefore, the author is limited to research in the best practices of SentinelOne
...
% SentinelOne's functionality regarding the main objective of this project. This means showing data related cyber-threat detection and
...
% benchmark against other security threat platforms. Therefore, \acrshort{api} request such as POST, PUT, DELETE, or PATCH is not necessary for
% this research.
...
% It is also crucial to note that these limitations do not undermine the overall scope of the research. The
