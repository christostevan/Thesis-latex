...
\begin{multicols}{2}
  ...
  \addcontentsline{toc}{subsection}{Sub-question \#1: What is the current situation of the QaaS app of
    Quality-ICT B.V.}
  \addcontentsline{toc}{subsection}{Sub-question \#2: How can SentinelOne be integrated into the QaaS app
    environment?}
  \addcontentsline{toc}{subsection}{Sub-question \#3: What are the most suitable visualization techniques for
