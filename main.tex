...
\newglossaryentry{CRM}{
    name=\acrshort{crm},
    description={ is a process or strategy that companies use to manage and analyze customer interactions and data throughout the customer lifecycle.
    \acrshort{crm} technology is a software system that helps organizations easily track all communications and nurture relationships with their leads 
    and clients \textit{\cite{crm}}
    }
}
\newglossaryentry{ERP}{
    name=\acrshort{erp},
    description={ is a type of software that organizations use to manage core day-to-day business activities needed to run a company such as accounting,
    finance, procurement, project management, manufacuring, risk management and compliance, \acrshort{hr}, and supply chain operations (\textit{\cite{erp}}) 
    }
}
\newglossaryentry{NoSQL}{
    ...
    than the tabular relations used in \acrshort{rdbms} (\textit{\cite{nosql}}). \acrshort{nosql} \acrshort{db}s are typically designed to handle large
...
\newglossaryentry{JSON}{
    ...
    also easy for machines to parse and generate too. It is based on a subset of the \acrshort{js}
    and is commonly used for representing structured data.(\textit{\cite{cronJob}})
    }
}
