...
\lstdefinelanguage{JavaScript}{ % Define JavaScript language in listing
  keywords={break, case, catch, continue, debugger, default, delete, do, else, false, finally, for, function, if, 
    in, instanceof, new, null, return, switch, this, throw, true, try, typeof, var, void, while, with, const, string,
    import, export },
  ...
  morestring=[b]',
  morestring=[b]",
  ndkeywords={class, export, boolean, throw, implements, import, this, constructor, boolean, number},
  sensitive=true,
...
{
    backgroundcolor=\color{dartBackcolour},   
